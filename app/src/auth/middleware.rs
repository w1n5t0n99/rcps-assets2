...
pub async fn check_user_password_status(
...
pub async fn extract_user_permissions(req: &mut ServiceRequest) -> Result<Vec<String>, actix_web::Error> {
    let client = req
        .extract::<ReqData<Client>>()
        .await
        .map_err(|_e| e500("User client not found")
